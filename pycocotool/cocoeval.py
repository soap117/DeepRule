...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[4] = _summarize(1, iouThr=.85, maxDets=self.params.maxDets[2])
            stats[5] = _summarize(1, iouThr=0.8999999999999999, maxDets=self.params.maxDets[2])
            stats[6] = _summarize(1, iouThr=.95, maxDets=self.params.maxDets[2])
