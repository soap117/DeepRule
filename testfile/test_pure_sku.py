...
if __name__ == "__main__":
    ...
    configs["system"]["data_dir"] = args.data_dir + '/juluo/skudata/'
    configs["system"]["cache_dir"] = args.data_dir + '/juluo/cache_pure_sku/'
    configs["system"]["result_dir"] = args.data_dir + '/juluo/cache_pure_sku/'
