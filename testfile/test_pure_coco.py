...
def test(db, split, testiter, debug=False, suffix=None):
    with torch.no_grad():
        ...
        from testfile.test_chart_pure import testing
...
if __name__ == "__main__":
    ...
    configs["system"]["data_dir"] = args.data_dir + '/juluo/cocodata/'
    configs["system"]["cache_dir"] = args.data_dir + '/juluo/cache_pure_coco/'
    configs["system"]["result_dir"] = args.data_dir + '/juluo/cache_pure_coco/'
