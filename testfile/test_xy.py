...
def parse_args():
    ...
    parser.add_argument("--cfg_file", dest="cfg_file", help="config file", default="CornerNetSimpleXY", type=str)
...
def test(db, split, testiter, debug=False, suffix=None):
    with torch.no_grad():
        ...
        from testfile.test_chart_xy import testing
...
if __name__ == "__main__":
    ...
    configs["system"]["data_dir"] = args.data_dir + '/juluo/chartdata/'
    configs["system"]["cache_dir"] = args.data_dir + '/juluo/cache_xy_new/'
    configs["system"]["result_dir"] = args.data_dir + '/juluo/cache_xy_new/'
