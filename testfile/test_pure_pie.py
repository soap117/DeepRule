...
def parse_args():
    ...
    parser.add_argument("--cfg_file", dest="cfg_file", help="config file", default="CornerNetPurePie", type=str)
    parser.add_argument("--testiter", dest="testiter",
                        help="test at iteration i",
                        default=55000, type=int)
...
def test(db, split, testiter, debug=False, suffix=None):
    with torch.no_grad():
        ...
        from testfile.test_pie_pure import testing
