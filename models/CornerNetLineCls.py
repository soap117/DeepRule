...
from .py_utils import kp_pure_line_cls, AELossLineCls, _neg_loss, convolution, residual, AELossLineClsFocal
...
loss = AELossLineCls(pull_weight=1e-1, push_weight=1e-1, focal_loss=_neg_loss, lamdb=1)