...
from .py_utils import kp_cls_pure, AELossPureCls, _neg_loss, convolution, residual
...
loss = AELossPureCls(pull_weight=1e-1, push_weight=1e-1, focal_loss=_neg_loss)